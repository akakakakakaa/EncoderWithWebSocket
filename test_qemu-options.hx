...
DEF("collabo", HAS_ARG, QEMU_OPTION_collabo,
    "-collabo [port=]port[,agent=agent][,seq=seq][,password=password]\n", QEMU_ARCH_ALL)
STEXI
@item -collabo [port=@var{port}][,agent=@var{agent}][,seq=@var{seq}][,password=@var{password}]
@findex -collabo
ETEXI
